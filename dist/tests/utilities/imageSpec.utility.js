...
describe("image processing test", () => {
    it("createImageFile func should return true", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const width = '120';
        const height = '120';
        const thumbPath = path_1.default.join(__dirname, "../assetsSpec/thumb", fileName +
            parseInt(width) +
            parseInt(height) +
            ".jpg");
        const created = yield (0, image_utility_1.createImageFile)(thumbPath, fileName, width, height);
